...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    ...
    const row = await createReview(auth.userId, "content", slug, parsed.data);
    ...
    console.error("[content reviews POST]", error);
    return NextResponse.json(
