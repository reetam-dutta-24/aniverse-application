...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    ...
    const row = await createReview(auth.userId, "artist", slug, parsed.data);
    ...
    console.error("[artist reviews POST]", error);
    return NextResponse.json(
