...
> = {
  content: {
    ...
    spotlightTitle: "Your Favourite Items In This Collection",
  ...
  music: {
    ...
    spotlightTitle: "Your Favourite Songs In This Collection",
    ...
    mostPlayedTitle: "Songs You Listened To The Most",
